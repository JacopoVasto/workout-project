  ...
  return (
    <header className="bg-white border-b">
      <div className="mx-auto flex h-16 max-w-screen-xl items-center justify-between gap-8 px-4 sm:px-6 lg:px-8">
        {/* Logo */}
        <Link className="block text-teal-600" to="/" onClick={() => setOpen(false)}>
        ...
        <button
          className="md:hidden rounded-sm bg-gray-100 p-2.5 text-gray-600 transition hover:text-gray-700"
        ...
        <nav aria-label="Global" className="hidden md:block ml-auto">
          <ul className="flex items-center gap-6 text-sm">
            <li>
              <Link to="/" className="text-gray-700 transition hover:text-gray-900">Home</Link>
            </li>
            <li>
          ...
          <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-4">
            <nav>
              <ul className="flex flex-col gap-3 text-sm">
                <li>
                  <Link to="/" className="block text-gray-700 hover:text-gray-900" onClick={() => setOpen(false)}>
                    Home
                  </Link>
                </li>
                <li>
                  <Link to="/schedule" className="block text-gray-700 hover:text-gray-900" onClick={() => setOpen(false)}>
                    Schedule
                  </Link>
                </li>
              </ul>
